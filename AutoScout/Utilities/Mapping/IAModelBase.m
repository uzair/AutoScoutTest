...
- (Class) classForKey:(NSString*) key
{
    ...
    int startingIndex = (int)[propertyString rangeOfString:startingString].location +
   (int) startingString.length;
    
    NSString *propType = [propertyString substringFromIndex:startingIndex];

    int endingIndex = (int)[propType rangeOfString:endingString].location;
